...
public class TesteCadastro {
	...
	public static void main(String[] args) {
		...
		/**
		 * Criação de um usuário comum, dando entrada nos parâmetros de email e nome de usuário com construtor padrão.
		 */
		UsuarioComum diego = new UsuarioComum();
		...
		/**
		 * Criação de usário comum utilizando o construtor que inicia com as informações de RG e CPF.
		 */
		
		UsuarioComum gabriel = new UsuarioComum("123456778", "123456120");
		...
		/**
		 * Criação de um usuário corporativo, dando entrada nos parâmetros de email e nome de usuário com construtor padrão.
		 */
		UsuarioCorporativo carlos = new UsuarioCorporativo();
		...
		/**
		 * Criação de usário corporativo utilizando o construtor que inicia com as informações do nome da empresa e CNPJ.
		 */
		UsuarioCorporativo caique = new UsuarioCorporativo("Grupo D","1234680001" );
		...
		System.out.println("CPF número: " + gabriel.getCpf());
		System.out.println("RG número: " + gabriel.getRg());
		...
		System.out.println("Empresa: " + caique.getNomeEmpresa());
		System.out.println("CNPJ número: " + caique.getCnpj());
